...
#theta was found to be the best model for hdi. The level parameter in the thetaf
...
austria_theta <- thetaf(austria_train$hdi, h=nrow(austria_test), level=95)

plot(y=austria_test$hdi, x=austria_test$Year, type='b', xlab='Year', ylab='hdi', 
...
belgium_theta <- thetaf(belgium_train$hdi, h=nrow(belgium_test), level=95)

plot(y=belgium_test$hdi, x=belgium_test$Year, type='b', xlab='Year', ylab='hdi', 
...
denmark_theta <- thetaf(denmark_train$hdi, h=nrow(denmark_test), level=95) 

plot(y=denmark_test$hdi, x=denmark_test$Year, type='b', xlab='Year', ylab='hdi', 
...
finland_theta <- thetaf(finland_train$hdi, h=nrow(finland_test), level=95) 

plot(y=finland_test$hdi, x=finland_test$Year, type='b', xlab='Year', ylab='hdi', 
...
france_theta <- thetaf(france_train$hdi, h=nrow(france_test), level=95) 

plot(y=france_test$hdi, x=france_test$Year, type='b', xlab='Year', ylab='hdi', 
...
germany_theta <- thetaf(germany_train$hdi, h=nrow(germany_test), level=95)

plot(y=germany_test$hdi, x=germany_test$Year, type='b', xlab='Year', ylab='hdi', 
...
ireland_theta <- thetaf(ireland_train$hdi, h=nrow(ireland_test), level=95)

plot(y=ireland_test$hdi, x=ireland_test$Year, type='b', xlab='Year', ylab='hdi', 
...
italy_theta <- thetaf(italy_train$hdi, h=nrow(italy_test), level=95)

plot(y=italy_test$hdi, x=italy_test$Year, type='b', xlab='Year', ylab='hdi', 
...
luxembourg_theta <- thetaf(luxembourg_train$hdi, h=nrow(luxembourg_test), level=95)

plot(y=luxembourg_test$hdi, x=luxembourg_test$Year, type='b', xlab='Year', ylab='hdi', 
...
netherlands_theta <- thetaf(netherlands_train$hdi, h=nrow(netherlands_test), level=95)

plot(y=netherlands_test$hdi, x=netherlands_test$Year, type='b', xlab='Year', ylab='hdi', 
...
portugal_theta <- thetaf(portugal_train$hdi, h=nrow(portugal_test), level=95)

plot(y=portugal_test$hdi, x=portugal_test$Year, type='b', xlab='Year', ylab='hdi', 
...
spain_theta <- thetaf(spain_train$hdi, h=nrow(spain_test), level=95)

plot(y=spain_test$hdi, x=spain_test$Year, type='b', xlab='Year', ylab='hdi', 
...
sweden_theta <- thetaf(sweden_train$hdi, h=nrow(sweden_test), level=95) 

plot(y=sweden_test$hdi, x=sweden_test$Year, type='b', xlab='Year', ylab='hdi', 
