...
#theta was found to be the best model for co2. The level parameter in the thetaf
...
austria_theta <- thetaf(austria_train$co2, h=nrow(austria_test), level=95)

plot(y=austria_test$co2, x=austria_test$Year, type='b', xlab='Year', ylab='co2', 
...
belgium_theta <- thetaf(belgium_train$co2, h=nrow(belgium_test), level=95)

plot(y=belgium_test$co2, x=belgium_test$Year, type='b', xlab='Year', ylab='co2', 
...
denmark_theta <- thetaf(denmark_train$co2, h=nrow(denmark_test), level=95) 

plot(y=denmark_test$co2, x=denmark_test$Year, type='b', xlab='Year', ylab='co2', 
...
finland_theta <- thetaf(finland_train$co2, h=nrow(finland_test), level=95) 

plot(y=finland_test$co2, x=finland_test$Year, type='b', xlab='Year', ylab='co2', 
...
france_theta <- thetaf(france_train$co2, h=nrow(france_test), level=95) 

plot(y=france_test$co2, x=france_test$Year, type='b', xlab='Year', ylab='co2', 
...
germany_theta <- thetaf(germany_train$co2, h=nrow(germany_test), level=95)

plot(y=germany_test$co2, x=germany_test$Year, type='b', xlab='Year', ylab='co2', 
...
ireland_theta <- thetaf(ireland_train$co2, h=nrow(ireland_test), level=95)

plot(y=ireland_test$co2, x=ireland_test$Year, type='b', xlab='Year', ylab='co2', 
...
italy_theta <- thetaf(italy_train$co2, h=nrow(italy_test), level=95)

plot(y=italy_test$co2, x=italy_test$Year, type='b', xlab='Year', ylab='co2', 
...
luxembourg_theta <- thetaf(luxembourg_train$co2, h=nrow(luxembourg_test), level=95)

plot(y=luxembourg_test$co2, x=luxembourg_test$Year, type='b', xlab='Year', ylab='co2', 
...
netherlands_theta <- thetaf(netherlands_train$co2, h=nrow(netherlands_test), level=95)

plot(y=netherlands_test$co2, x=netherlands_test$Year, type='b', xlab='Year', ylab='co2', 
     ylim=c(min(netherlands_test$co2)-1, max(netherlands_theta$upper)), main='netherlands')
...
portugal_theta <- thetaf(portugal_train$co2, h=nrow(portugal_test), level=95)

plot(y=portugal_test$co2, x=portugal_test$Year, type='b', xlab='Year', ylab='co2', 
...
spain_theta <- thetaf(spain_train$co2, h=nrow(spain_test), level=95)

plot(y=spain_test$co2, x=spain_test$Year, type='b', xlab='Year', ylab='co2', 
...
sweden_theta <- thetaf(sweden_train$co2, h=nrow(sweden_test), level=95) 

plot(y=sweden_test$co2, x=sweden_test$Year, type='b', xlab='Year', ylab='co2', 
