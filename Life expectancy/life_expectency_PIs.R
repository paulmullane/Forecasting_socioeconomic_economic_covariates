...
#theta was found to be the best model for life_exp. The level parameter in the thetaf
...
austria_theta <- thetaf(austria_train$life_exp, h=nrow(austria_test), level=95)

plot(y=austria_test$life_exp, x=austria_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
belgium_theta <- thetaf(belgium_train$life_exp, h=nrow(belgium_test), level=95)

plot(y=belgium_test$life_exp, x=belgium_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
denmark_theta <- thetaf(denmark_train$life_exp, h=nrow(denmark_test), level=95) 

plot(y=denmark_test$life_exp, x=denmark_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
finland_theta <- thetaf(finland_train$life_exp, h=nrow(finland_test), level=95) 

plot(y=finland_test$life_exp, x=finland_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
france_theta <- thetaf(france_train$life_exp, h=nrow(france_test), level=95) 

plot(y=france_test$life_exp, x=france_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
germany_theta <- thetaf(germany_train$life_exp, h=nrow(germany_test), level=95)

plot(y=germany_test$life_exp, x=germany_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
ireland_theta <- thetaf(ireland_train$life_exp, h=nrow(ireland_test), level=95)

plot(y=ireland_test$life_exp, x=ireland_test$Year, type='b', xlab='Year', ylab='life_exp', 
     ylim=c(min(ireland_theta$lower), max(ireland_theta$upper)), main='ireland')
...
italy_theta <- thetaf(italy_train$life_exp, h=nrow(italy_test), level=95)

plot(y=italy_test$life_exp, x=italy_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
luxembourg_theta <- thetaf(luxembourg_train$life_exp, h=nrow(luxembourg_test), level=95)

plot(y=luxembourg_test$life_exp, x=luxembourg_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Luxembourg",
    y_test = luxembourg_test$life_exp,
...
netherlands_theta <- thetaf(netherlands_train$life_exp, h=nrow(netherlands_test), level=95)

plot(y=netherlands_test$life_exp, x=netherlands_test$Year, type='b', xlab='Year', ylab='life_exp', 
     ylim=c(min(netherlands_test$life_exp)-1, max(netherlands_theta$upper)), main='netherlands')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Netherlands",
    y_test = netherlands_test$life_exp,
...
portugal_theta <- thetaf(portugal_train$life_exp, h=nrow(portugal_test), level=95)

plot(y=portugal_test$life_exp, x=portugal_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
spain_theta <- thetaf(spain_train$life_exp, h=nrow(spain_test), level=95)

plot(y=spain_test$life_exp, x=spain_test$Year, type='b', xlab='Year', ylab='life_exp', 
...
sweden_theta <- thetaf(sweden_train$life_exp, h=nrow(sweden_test), level=95) 

plot(y=sweden_test$life_exp, x=sweden_test$Year, type='b', xlab='Year', ylab='life_exp', 
