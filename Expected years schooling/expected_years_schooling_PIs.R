...
#theta was found to be the best model for expected_years_schooling. The level parameter in the thetaf
...
austria_theta <- thetaf(austria_train$expected_years_schooling, h=nrow(austria_test), level=95)

plot(y=austria_test$expected_years_schooling, x=austria_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Austria",
    y_test = austria_test$expected_years_schooling,
...
belgium_theta <- thetaf(belgium_train$expected_years_schooling, h=nrow(belgium_test), level=95)

plot(y=belgium_test$expected_years_schooling, x=belgium_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Belgium",
    y_test = belgium_test$expected_years_schooling,
...
denmark_theta <- thetaf(denmark_train$expected_years_schooling, h=nrow(denmark_test), level=95) 

plot(y=denmark_test$expected_years_schooling, x=denmark_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Denmark",
    y_test = denmark_test$expected_years_schooling,
...
finland_theta <- thetaf(finland_train$expected_years_schooling, h=nrow(finland_test), level=95) 

plot(y=finland_test$expected_years_schooling, x=finland_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Finland",
    y_test = finland_test$expected_years_schooling,
...
france_theta <- thetaf(france_train$expected_years_schooling, h=nrow(france_test), level=95) 

plot(y=france_test$expected_years_schooling, x=france_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "France",
    y_test = france_test$expected_years_schooling,
...
germany_theta <- thetaf(germany_train$expected_years_schooling, h=nrow(germany_test), level=95)

plot(y=germany_test$expected_years_schooling, x=germany_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Germany",
    y_test = germany_test$expected_years_schooling,
...
ireland_theta <- thetaf(ireland_train$expected_years_schooling, h=nrow(ireland_test), level=95)

plot(y=ireland_test$expected_years_schooling, x=ireland_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Ireland",
    y_test = ireland_test$expected_years_schooling,
...
italy_theta <- thetaf(italy_train$expected_years_schooling, h=nrow(italy_test), level=95)

plot(y=italy_test$expected_years_schooling, x=italy_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Italy",
    y_test = italy_test$expected_years_schooling,
...
luxembourg_theta <- thetaf(luxembourg_train$expected_years_schooling, h=nrow(luxembourg_test), level=95)

plot(y=luxembourg_test$expected_years_schooling, x=luxembourg_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Luxembourg",
    y_test = luxembourg_test$expected_years_schooling,
...
netherlands_theta <- thetaf(netherlands_train$expected_years_schooling, h=nrow(netherlands_test), level=95)

plot(y=netherlands_test$expected_years_schooling, x=netherlands_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Netherlands",
    y_test = netherlands_test$expected_years_schooling,
...
portugal_theta <- thetaf(portugal_train$expected_years_schooling, h=nrow(portugal_test), level=95)

plot(y=portugal_test$expected_years_schooling, x=portugal_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Portugal",
    y_test = portugal_test$expected_years_schooling,
...
spain_theta <- thetaf(spain_train$expected_years_schooling, h=nrow(spain_test), level=95)

plot(y=spain_test$expected_years_schooling, x=spain_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Spain",
    y_test = spain_test$expected_years_schooling,
...
sweden_theta <- thetaf(sweden_train$expected_years_schooling, h=nrow(sweden_test), level=95) 

plot(y=sweden_test$expected_years_schooling, x=sweden_test$Year, type='b', xlab='Year', ylab='expected_years_schooling', 
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Sweden",
    y_test = sweden_test$expected_years_schooling,
