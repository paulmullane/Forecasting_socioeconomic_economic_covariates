...
#theta was found to be the best model for GDP. The level parameter in the thetaf
...
austria_theta <- thetaf(austria_train$GDP, h=nrow(austria_test), level=95)

plot(y=austria_test$GDP, x=austria_test$Year, type='b', xlab='Year', ylab='GDP', 
...
belgium_theta <- thetaf(belgium_train$GDP, h=nrow(belgium_test), level=95)

plot(y=belgium_test$GDP, x=belgium_test$Year, type='b', xlab='Year', ylab='GDP', 
...
denmark_theta <- thetaf(denmark_train$GDP, h=nrow(denmark_test), level=95) 

plot(y=denmark_test$GDP, x=denmark_test$Year, type='b', xlab='Year', ylab='GDP', 
...
finland_theta <- thetaf(finland_train$GDP, h=nrow(finland_test), level=95) 

plot(y=finland_test$GDP, x=finland_test$Year, type='b', xlab='Year', ylab='GDP', 
...
france_theta <- thetaf(france_train$GDP, h=nrow(france_test), level=95) 

plot(y=france_test$GDP, x=france_test$Year, type='b', xlab='Year', ylab='GDP', 
...
germany_theta <- thetaf(germany_train$GDP, h=nrow(germany_test), level=95)

plot(y=germany_test$GDP, x=germany_test$Year, type='b', xlab='Year', ylab='GDP', 
...
ireland_theta <- thetaf(ireland_train$GDP, h=nrow(ireland_test), level=95)

plot(y=ireland_test$GDP, x=ireland_test$Year, type='b', xlab='Year', ylab='GDP', 
     ylim=c(min(ireland_test$GDP), max(ireland_test$GDP)), main='ireland')
...
italy_theta <- thetaf(italy_train$GDP, h=nrow(italy_test), level=95)

plot(y=italy_test$GDP, x=italy_test$Year, type='b', xlab='Year', ylab='GDP', 
...
luxembourg_theta <- thetaf(luxembourg_train$GDP, h=nrow(luxembourg_test), level=95)

plot(y=luxembourg_test$GDP, x=luxembourg_test$Year, type='b', xlab='Year', ylab='GDP', 
...
netherlands_theta <- thetaf(netherlands_train$GDP, h=nrow(netherlands_test), level=95)

plot(y=netherlands_test$GDP, x=netherlands_test$Year, type='b', xlab='Year', ylab='GDP', 
...
portugal_theta <- thetaf(portugal_train$GDP, h=nrow(portugal_test), level=95)

plot(y=portugal_test$GDP, x=portugal_test$Year, type='b', xlab='Year', ylab='GDP', 
...
spain_theta <- thetaf(spain_train$GDP, h=nrow(spain_test), level=95)

plot(y=spain_test$GDP, x=spain_test$Year, type='b', xlab='Year', ylab='GDP', 
...
sweden_theta <- thetaf(sweden_train$GDP, h=nrow(sweden_test), level=95) 

plot(y=sweden_test$GDP, x=sweden_test$Year, type='b', xlab='Year', ylab='GDP', 
