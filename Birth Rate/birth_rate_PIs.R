...
#Load the data----
Austria <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Austria.xlsx")[,c('Year', 'birth_rate')])
Belgium <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Belgium.xlsx")[,c('Year', 'birth_rate')])
Denmark<- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Denmark.xlsx")[,c('Year', 'birth_rate')])
Finland <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Finland.xlsx")[,c('Year', 'birth_rate')])
France <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/France.xlsx")[,c('Year', 'birth_rate')])
Germany <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Germany.xlsx")[,c('Year', 'birth_rate')])
Ireland <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Ireland.xlsx")[,c('Year', 'birth_rate')])
Italy <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Italy.xlsx")[,c('Year', 'birth_rate')])
Luxembourg <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Luxembourg.xlsx")[,c('Year', 'birth_rate')])
Netherlands <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Netherlands.xlsx")[,c('Year', 'birth_rate')])
Portugal <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Portugal.xlsx")[,c('Year', 'birth_rate')])
Spain <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Spain.xlsx")[,c('Year', 'birth_rate')])
Sweden <- na.omit(read_excel("Desktop/Covariate Forecasting/Country data/Sweden.xlsx")[,c('Year', 'birth_rate')])
...
austria_ets <- ets(austria_train$birth_rate, model="ZZN")
...
plot(y=forecast_austria_ets$mean, x=austria_test$Year, type='b',
     ...
     main='Austria', xlab='Year', ylab='birth rate', col='red')
lines(y=austria_test$birth_rate, x=austria_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Austria",
    y_test = austria_test$birth_rate,
...
belgium_ets <- ets(belgium_train$birth_rate, model="ZZN")
...
plot(y=forecast_belgium_ets$mean, x=belgium_test$Year, type='b',
     ...
     main='belgium', xlab='Year', ylab='birth rate', col='red')
lines(y=belgium_test$birth_rate, x=belgium_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Belgium",
    y_test = belgium_test$birth_rate,
...
denmark_ets <- ets(denmark_train$birth_rate, model="ZZN")
...
plot(y=forecast_denmark_ets$mean, x=denmark_test$Year, type='b',
     ...
     main='denmark', xlab='Year', ylab='birth rate', col='red')
lines(y=denmark_test$birth_rate, x=denmark_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Denmark",
    y_test = denmark_test$birth_rate,
...
finland_ets <- ets(finland_train$birth_rate, model="ZZN")
...
plot(y=forecast_finland_ets$mean, x=finland_test$Year, type='b',
     ...
     main='finland', xlab='Year', ylab='birth rate', col='red')
lines(y=finland_test$birth_rate, x=finland_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Finland",
    y_test = finland_test$birth_rate,
...
france_ets <- ets(france_train$birth_rate, model="ZZN")
...
plot(y=forecast_france_ets$mean, x=france_test$Year, type='b',
     ...
     main='france', xlab='Year', ylab='birth rate', col='red')
lines(y=france_test$birth_rate, x=france_test$Year, type='b')
...
germany_ets <- ets(germany_train$birth_rate, model="ZZN")
...
plot(y=forecast_germany_ets$mean, x=germany_test$Year, type='b',
     ...
     main='germany', xlab='Year', ylab='birth rate', col='red')
lines(y=germany_test$birth_rate, x=germany_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Germany",
    y_test = germany_test$birth_rate,
...
ireland_ets <- ets(ireland_train$birth_rate, model="ZZN")
...
plot(y=forecast_ireland_ets$mean, x=ireland_test$Year, type='b',
     ...
     main='ireland', xlab='Year', ylab='birth rate', col='red')
lines(y=ireland_test$birth_rate, x=ireland_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Ireland",
    y_test = ireland_test$birth_rate,
...
italy_ets <- ets(italy_train$birth_rate, model="ZZN")
...
plot(y=forecast_italy_ets$mean, x=italy_test$Year, type='b',
     ...
     main='italy', xlab='Year', ylab='birth rate', col='red')
lines(y=italy_test$birth_rate, x=italy_test$Year, type='b')
...
luxembourg_ets <- ets(luxembourg_train$birth_rate, model="ZZN")
...
plot(y=forecast_luxembourg_ets$mean, x=luxembourg_test$Year, type='b',
     ...
     main='luxembourg', xlab='Year', ylab='birth rate', col='red')
lines(y=luxembourg_test$birth_rate, x=luxembourg_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Luxembourg",
    y_test = luxembourg_test$birth_rate,
...
netherlands_ets <- ets(netherlands_train$birth_rate, model="ZZN")
...
plot(y=forecast_netherlands_ets$mean, x=netherlands_test$Year, type='b',
     ...
     main='netherlands', xlab='Year', ylab='birth rate', col='red')
lines(y=netherlands_test$birth_rate, x=netherlands_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Netherlands",
    y_test = netherlands_test$birth_rate,
...
portugal_ets <- ets(portugal_train$birth_rate, model="ZZN")
...
plot(y=forecast_portugal_ets$mean, x=portugal_test$Year, type='b',
     ...
     main='portugal', xlab='Year', ylab='birth rate', col='red')
lines(y=portugal_test$birth_rate, x=portugal_test$Year, type='b')
...
results_df <- rbind(
  ...
  pi_diagnostics(
    country = "Portugal",
    y_test = portugal_test$birth_rate,
...
spain_ets <- ets(spain_train$birth_rate, model="ZZN")
...
plot(y=forecast_spain_ets$mean, x=spain_test$Year, type='b',
     ...
     main='spain', xlab='Year', ylab='birth rate', col='red')
lines(y=spain_test$birth_rate, x=spain_test$Year, type='b')
...
sweden_ets <- ets(sweden_train$birth_rate, model="ZZN")
...
plot(y=forecast_sweden_ets$mean, x=sweden_test$Year, type='b',
     ...
     main='sweden', xlab='Year', ylab='birth rate', col='red')
lines(y=sweden_test$birth_rate, x=sweden_test$Year, type='b')
